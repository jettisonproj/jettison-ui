...
import type { Rollout, RolloutPhase } from "src/data/types/rolloutTypes.ts";
...
interface ArgoCDStatusResponseBase {
  argocdStatus:
    | typeof ArgoCDStatuses.Loading
    | typeof ArgoCDStatuses.ApplicationNotFound
    | typeof ArgoCDStatuses.ApplicationRolloutNotFound
    | typeof ArgoCDStatuses.RolloutNotFound
    | typeof ArgoCDStatuses.ApplicationResourceNotFound
    | typeof ArgoCDStatuses.RolloutStatusDegraded
    | typeof ArgoCDStatuses.ApplicationHealthDegraded
    | typeof ArgoCDStatuses.ApplicationOutOfSync
    | typeof ArgoCDStatuses.RolloutVersionNotFound
    | typeof ArgoCDStatuses.ApplicationSyncDisabled
    | typeof ArgoCDStatuses.ApplicationHealthUnknown
    | typeof ArgoCDStatuses.ApplicationSyncUnknown
    | typeof ArgoCDStatuses.Healthy;
}

interface RolloutVersionMismatchResponse {
  argocdStatus: typeof ArgoCDStatuses.RolloutVersionMismatch;
  expectedRolloutVersion: string;
  rolloutVersion: string;
}

interface DeployingResponse {
  argocdStatus: typeof ArgoCDStatuses.Deploying;
  rolloutPhase: RolloutPhase;
  applicationHealthStatus: HealthStatusCode;
}

type ArgoCDStatusResponse =
  | ArgoCDStatusResponseBase
  | RolloutVersionMismatchResponse
  | DeployingResponse;
